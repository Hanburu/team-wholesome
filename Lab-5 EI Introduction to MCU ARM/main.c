...
{
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P2, GPIO_PIN7 + GPIO_PIN6 );
}
else if (((2/8)*(ref_ADC)) < inovref && inovref <=((3/8)*(ref_ADC)))
{
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P2, GPIO_PIN7 + GPIO_PIN6 + GPIO_PIN4 );
}
...
{
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P2, GPIO_PIN7 + GPIO_PIN6 + GPIO_PIN4 + GPIO_PIN3 );
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P5, GPIO_PIN6 );
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P6, GPIO_PIN6 + GPIO_PIN7 );
}
...
{
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P2, GPIO_PIN7 + GPIO_PIN6 + GPIO_PIN4 + GPIO_PIN3 );
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P5, GPIO_PIN6 + GPIO_PIN1 );
	GPIO_setOutputHighOnPin	(	GPIO_PORT_P6, GPIO_PIN6 + GPIO_PIN7 );	
}
else
{
